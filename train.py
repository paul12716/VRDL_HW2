...
from retinanet.dataloader import CocoDataset, HW2Dataset, CSVDataset, collater, Resizer, AspectRatioBasedSampler, Augmenter, \
    Normalizer
...
def main(args=None):
    ...
    dataloader_train = DataLoader(dataset_train, batch_size=8, num_workers=3, collate_fn=collater)
    ...
    for epoch_num in range(pre_epoch, parser.epochs):
        ...
        torch.save(retinanet.module, 'saved_models_3/{}_retinanet_{}.pt'.format(parser.dataset, epoch_num))
